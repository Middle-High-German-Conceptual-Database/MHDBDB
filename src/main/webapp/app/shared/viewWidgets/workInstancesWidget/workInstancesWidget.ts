...
@Component({
    selector: 'dhpp-widget-work-instances',
    templateUrl: './workInstancesWidget.html',
    styleUrls: ['./workInstancesWidget.scss']
})
export class WorkInstancesWidgetComponent extends ViewWidgetsDirective<WorkQueryParameterI, WorkFilterI, WorkOptionsI, MhdbdbIdEntity, WorkService> implements OnInit {
...
@Component({
    selector: 'dhpp-widget-work-instances-help',
    templateUrl: './workInstancesWidgetHelp.html',
})
export class WorkInstancesWidgetHelpComponent { }
