...
import { NAMESPACES, SERVER_API_SPARQL_URL } from '../../../../../src/main/webapp/app/app.constants';
 ...
 * @template E
 */
export abstract class MhdbdbGraphService<P extends QueryParameterI<F, O>, F extends FilterI, O extends OptionsI, E extends MhdbdbEntity> implements MhdbdbGraphServiceI<P, F, O, E> {
 ...
 * @template E
 */
export abstract class MhdbdbIdLabelEntityService<P extends QueryParameterI<F, O>, F extends FilterIdLabelI, O extends OptionsI, E extends MhdbdbIdLabelEntity> extends MhdbdbGraphService<P, F, O, E> {
