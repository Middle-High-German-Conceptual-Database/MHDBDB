...
import { FilterIdLabelI, FilterSkosI, MhdbdbIdLabelEntityService, OptionsI, QueryParameterI, SparqlBindingI } from '../mhdbdb-graph.service';
...
export interface SkosConceptServiceI<P extends skosQueryParameterMap<F, O>, F extends skosFilterMap, O extends skosOptionsMap, E extends SkosConcept> extends MhdbdbIdLabelEntityService<P, F, O, E> {
...
export abstract class SkosConceptService<P extends skosQueryParameterMap<F, O>, F extends skosFilterMap, O extends skosOptionsMap, E extends SkosConcept> extends MhdbdbIdLabelEntityService<P, F, O, E> implements SkosConceptServiceI<P, F, O, E>{
