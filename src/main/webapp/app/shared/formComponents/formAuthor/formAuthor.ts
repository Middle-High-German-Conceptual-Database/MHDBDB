...
export class FormAuthorComponent<qT extends QueryParameterI<f, o>, f extends FilterLabelI, o extends OptionsI, instanceClass>
  ...
  constructor(public historyService: HistoryService<qT, f, o, instanceClass>, public help: MatDialog) {
