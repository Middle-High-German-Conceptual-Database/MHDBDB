...
export class AccountService {
  ...
  constructor(private languageService: LanguageService, private sessionStorage: SessionStorageService, private http: HttpClient) {}
  ...
  save(account: Account): Observable<Account> {
    return this.http.post<Account>(SERVER_API_URL + 'services/uaa/api/account', account);
  }
