...
import { MhdbdbEntity, MhdbdbIdEntity, MhdbdbIdLabelEntity } from 'app/shared/baseIndexComponent/baseindexcomponent.class';
...
export class XmlElement {
  constructor(public id: string, public n: number) {}
}
...
export class Line extends XmlElement {
  ...
  constructor(public id: string, public n: number, public tokens: Token[]) {
    super(id, n);
  }
}
...
export class TextPassage extends MhdbdbEntity {
  ...
  constructor(public lines: Line[], public text: ElectronicText) {
    super();
  }
}
...
export class Token extends MhdbdbIdEntity {
  ...
  public quote?: Quote;
  constructor(public id: string, public n: number, public content: string) {
    super(id);
  }
}

export class Quote {
  constructor(public text: ElectronicText, public line: Line) {}
}

export class Kwic {
  constructor(public left: Token[], public center: Token, public right: Token[]) {}
}
