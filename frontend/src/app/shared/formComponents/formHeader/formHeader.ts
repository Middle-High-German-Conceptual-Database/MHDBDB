...
@Component({
    selector: 'dhpp-form-header',
    templateUrl: './formHeader.html',
    styleUrls: ['./formHeader.scss']
})
export class FormHeaderComponent<qT extends QueryParameterI<f, o>, f extends FilterPosI, o extends OptionsI, instanceClass> {
    ...
    subscribeForm(): Subscription {
        return this.form
            ...
            .subscribe(
                ...
                error => { console.error("FormHeaderComponent subscribeForm", error) }
            )
    }
    ...
    subscribeHistory(): Subscription {
        return this.he.history
            .subscribe(
                ...
                error => { console.error("FormHeaderComponent subscribeHistory", error) }
            )
    }
