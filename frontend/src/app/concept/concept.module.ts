...
@NgModule({
  declarations: [ConceptComponent, ConceptViewComponent, ConceptListComponent, ConceptTreeComponent],
  entryComponents: [ConceptComponent, ConceptViewComponent, ConceptListComponent, ConceptTreeComponent],
  imports: [
