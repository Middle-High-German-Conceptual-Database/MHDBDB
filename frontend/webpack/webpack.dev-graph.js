...
module.exports = (options) => webpackMerge(commonConfig({
  ...
  devServer: {
    ...
    contentBase: './build/resources/main/static/graph/',
    //baseUrl: '/graph/',
    proxy: [
      {
        context: [
          ...
          '/graph/showTeiAsHtml',
          '/graph/loading',
          '/graph/downloadTeiXml', 
          '/graph/downloadTeiPdf',
        ],
  ...
  output: {
    path: utils.root('build/resources/main/static/graph/'),
